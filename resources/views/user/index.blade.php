            ...
            <div class="row justify-content-center">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    @foreach ($post as $value)
                        <article class="card mb-4">
                            <div class="post-slider">
                                <img src="{{ asset('backend/post_thumbnail/' . $value->thumbnail) }}" class="card-img-top"
                                    alt="post-thumb">
                            </div>
                            <div class="card-body">
                                <h3 class="mb-3"><a class="post-title" 
                                    href="{{route('single_post_view', $value->id)}}"> 
                                    {{ $value->title }} </a>
                                </h3>
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline-item">
                                        <ul class="card-meta-tag list-inline">
                                         Category :  <b class="text-danger">{{$value->category_name}}</b>
                                        </ul>
                                    </li>
                                </ul>
                                <p>{{$value->description}}</p>
                                <a href="{{route('single_post_view', $value->id)}}" class="btn btn-outline-primary">Read More</a>
                            </div>
                        </article>
                    @endforeach
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('frontend/images/post/post-5.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('frontend/images/post/post-8.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                            <img src="{{ asset('frontend/images/post/post-9.jpg') }}" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes
