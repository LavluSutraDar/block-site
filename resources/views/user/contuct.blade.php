        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <form method="POST" action="{{ route('contuct_message') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="message" id="message" class="summernote form-control @error('message') is-invalid @enderror"></textarea>
